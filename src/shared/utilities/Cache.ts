...
export const Cookie = {
     ...
     * @param ex
     */
    set: (cname: string, cvalue: any, ex: any) => {
     ...
     */
    get: (cname: string) => {
        if (cname === CUSTOM_CONSTANTS.APP_VARIABLE && !Encryption.decrypt(Cookie.prepareGet(CUSTOM_CONSTANTS.APP_VARIABLE))) {
            return null;
        }
